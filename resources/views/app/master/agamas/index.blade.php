  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-button">
        <a href="{{ route('agamas.create') }}">
          <h4 class="btn btn-info ">Tambah Agama</h4>
        </a>
      </div>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a>Beranda</a></div>
        <div class="breadcrumb-item"><a>Master Data</a></div>
        <div class="breadcrumb-item">Data Agama</div>
      </div>
    </div>
                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $res->nama_agama }}</td>
                      <td class="text-center">
                        <a href="{{ route('agamas.edit', $res->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        <button href="#" class="btn btn-danger" data-uri="{{ route('agamas.destroy', $res->id) }}" data-toggle="modal" data-target="#deleteConf"><i class="fas fa-trash"></i></button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
