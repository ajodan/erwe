...
<section class="section">
    <div class="section-header">
        ...
        <h1>Ubah Jenis Disabilitas</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a>Beranda</a></div>
            <div class="breadcrumb-item"><a>Master Data</a></div>
            <div class="breadcrumb-item">Ubah Jenis Disabilitas</div>
        </div>
    </div>

    <div class="section-body">
    <form method="POST" action="{{ route('cacats.update', $cacats->id) }}" enctype="multipart/form-data">
        @csrf
        {{ method_field('PUT') }}
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input id="jenis_cacat" type="text" class="form-control @error('jenis_cacat') is-invalid @enderror" name="jenis_cacat" value="{{ $cacats->jenis_cacat }}" required autocomplete="jenis_cacat" autofocus>
                            </div>
