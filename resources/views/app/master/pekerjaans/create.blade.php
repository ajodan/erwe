...
<section class="section">
    ...
    <form method="POST" action="{{ route('pekerjaans.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input id="nama_pekerjaan" type="text" class="form-control @error('nama_pekerjaan') is-invalid @enderror" name="nama_pekerjaan" value="{{ old('nama_pekerjaan') }}" required autocomplete="nama_pekerjaan" autofocus>
                            </div>
                        </div>
