...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{route('pekerjaans.index')}}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Ubah Pekerjaan</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a>Beranda</a></div>
            <div class="breadcrumb-item"><a>Master Data</a></div>
            <div class="breadcrumb-item">Ubah Pekerjaan</div>
        </div>
    </div>

    <div class="section-body">
    <form method="POST" action="{{ route('pekerjaans.update', $pekerjaans->id) }}" enctype="multipart/form-data">
        @csrf
        {{ method_field('PUT') }}
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input id="nama_pekerjaan" type="text" class="form-control @error('nama_pekerjaan') is-invalid @enderror" name="nama_pekerjaan" value="{{ $pekerjaans->nama_pekerjaan }}" required autocomplete="nama_pekerjaan" autofocus>
                            </div>
