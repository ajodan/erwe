  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-button">
        <a href="{{ route('pekerjaans.create') }}">
                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $res->nama_pekerjaan }}</td>
                      <td class="text-center">
                        <a href="{{ route('pekerjaans.edit', $res->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        <button href="#" class="btn btn-danger" data-uri="{{ route('pekerjaans.destroy', $res->id) }}" data-toggle="modal" data-target="#deleteConf"><i class="fas fa-trash"></i></button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
