                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $res->no_telp }}</td>
                      <td class="text-center"><p class="badge badge-success"> {{ $res->level }} </p></td>
                      <td class="text-center">
                        <a href="{{ route('profils.edit', $res->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        {{-- <button href="#" class="btn btn-danger" data-uri="{{ route('profils.destroy', $res->id) }}" data-toggle="modal" data-target="#deleteConf"><i class="fas fa-trash"></i></button> --}}
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
