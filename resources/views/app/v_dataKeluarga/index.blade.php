    ...
    <div class="section-header">
      ...
      <div class="section-header-button">
        {{-- <a href="{{ route('data_keluargas.create') }}">
          <h4 class="btn btn-info ">Tambah Data Keluarga</h4>
        </a> --}}
      </div>
        ...
        <div class="col-12">
            <div class="card-body">
              <div class="table-responsive">
                <a href="{{ route('datakeluarga.export') }}">
                  <h2 class="btn btn-primary">Cetak Excel</h2>
                </a>
                <table class="table table-striped" id="table-1">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Status KK</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">{{ $res->status_rumah }}</td>
                      <td class="text-center">{{ $res->status_ktp }}</td>
                      @if (Auth::user()->level == 'Rw')
