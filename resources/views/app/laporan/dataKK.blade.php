        ...
        <div class="section-body">
            <div class="alert alert-primary alert-dismissible show fade">
                <div class="alert-body">
                    ...
                    <strong class="h6">
                        Catatan : Cari Berdasarkan Nama Kepala Keluarga / Nomor Kartu Keluarga.
                    </strong>
                </div>
            </div>
            <div class="row">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-job text-muted"> 
                                            @foreach($pekerjaans as $res2)
                                            @if($res2->id == $res->pekerjaan_id)
                                            <p class="lead">{{ $res2->nama_pekerjaan }}</p>
                                            @endif
                                            @endforeach</div>
                                    </div>
                                    <div class="media-progressbar">
                                        <a class="btn btn-sm btn-round btn-success" style="color: white;">
                                            {{ $res->nik }}
                                        </a>
                                    </div>
                                    <div class="media-progressbar">
                                    ...
                                    <div class="media-cta">
                                        <button class="btn btn-primary btnDetail" _IdKK="{{ $res->no_kk }}" _dNik="{{ $res->nik }}" _dName="{{ $res->nama_lengkap }}" _dJenisKelamin="{{ $res->jenis_kelamin }}" _dTTL="{{ $res->tempat_lahir }}, {{ $res->tanggal_lahir }}", 0, 120>Detail</button>
                                    </div>
                                </li>
                                @endforeach
                                @endif
...
<script>
    ...
    $('.btnDetail').click(function(e) {
        ...
        let dJenisKelamin = $(this).attr('_dJenisKelamin')
        ...
        $('#dName').html(dName)
        $('#dTTL').html(dTTL)
        $('#dJenisKelamin').html(dJenisKelamin)
