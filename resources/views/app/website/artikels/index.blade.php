    ...
    <div class="section-header">
      ...
      <div class="section-header-button">
        <a href="{{ route('artikels.create') }}">
          <h4 class="btn btn-info ">Tambah Artikel</h4>
        </a>
      </div>
                ...
                <table class="table table-striped" id="table-1">
                  <thead>
                    <tr>
                      ...
                      <th class="text-left">Judul Artikel</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center"><img alt="Gambar Artikel" src="{{asset('UploadedFile/gambarArtikel/'.$res->gambar)}}" height="70" width="80"></td>
                      <td class="text-center">{{ $res->created_by }}</td>
                      <td class="text-center">
                        <a href="{{ route('artikels.edit', $res->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        <button href="#" class="btn btn-danger" data-uri="{{ route('artikels.destroy', $res->id) }}" data-toggle="modal" data-target="#deleteConf"><i class="fas fa-trash"></i></button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
