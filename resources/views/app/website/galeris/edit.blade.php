...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Ubah Galeri</div>
        </div>
    </div>

    <div class="section-body">
    <form method="POST" action="{{ route('galeris.update', $galeris->id) }}" enctype="multipart/form-data">
        @csrf
        {{ method_field('PUT') }}
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control selectric" name="kategori_galeri_id">
                            ...
                            @if($res->id == $galeris->kategori_galeri_id)
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input id="judul" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ $galeris->judul }}" required autocomplete="judul" autofocus>
                    </div>
                   
                    <div class="form-group col-md-12">
                        <img alt="Gambar Galeri" src="{{asset('UploadedFile/gambarGaleri/'.$galeris->gambar)}}" height="300" width="400">
                    </div>
