...
<meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="{{asset('assets/stisla/modules/weather-icon/css/weather-icons.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/stisla/modules/weather-icon/css/weather-icons-wind.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('assets/stisla/modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('assets/stisla/modules/bootstrap-daterangepicker/daterangepicker.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('assets/stisla/modules/owlcarousel2/dist/assets/owl.theme.default.min.css')}}">
