        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown" id="statusLink">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li id="pendidikanLink"><a class="nav-link" href="{{ route('pendidikans.index') }}">Artikel</a></li>
                    <li id="pekerjaanLink"><a class="nav-link" href="{{ route('pekerjaans.index') }}">Galeri</a></li>
            ...
            <li class="dropdown" id="statusLink">
                ...
                <ul class="dropdown-menu">
                    <li id="agamaLink"><a class="nav-link" href="{{ route('agamas.index') }}">Data Warga</a></li>
                    <li id="pernikahanLink"><a class="nav-link" href="{{ route('status_pernikahans.index') }}">Data Agama</a></li>
                    <li id="cacatLink"><a class="nav-link" href="{{ route('cacats.index') }}">Data Jenis Kelamin</a></li>
                    <li id="pendidikanLink"><a class="nav-link" href="{{ route('pendidikans.index') }}">Data Pendidikan</a></li>
                    <li id="pekerjaanLink"><a class="nav-link" href="{{ route('pekerjaans.index') }}">Data Pekerjaan</a></li>
                    <li id="cacatLink"><a class="nav-link" href="{{ route('cacats.index') }}">Status Domisili KK/KTP</a></li>
                    <li id="kkLink"><a class="nav-link" href="{{ route('status_kartu_keluargas.index') }}">Data Kelompok Usia</a></li>
                    <li id="kkLink"><a class="nav-link" href="{{ route('status_kartu_keluargas.index') }}">Status Pernikahan</a></li>
                    <li id="pernikahanLink"><a class="nav-link" href="{{ route('status_pernikahans.index') }}">Data Golongan Darah</a></li>
                </ul>
            </li>
            @endif
